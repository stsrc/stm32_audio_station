...
static void TM_ILI9341_Delay(volatile long unsigned int delay);
...
void TM_ILI9341_Init()
{
	...
	ILI9341_CS_PORT->MODER |= GPIO_MODER_MODER0_0;
	ILI9341_WRX_PORT->MODER |= GPIO_MODER_MODER1_0;
	ILI9341_RST_PORT->MODER |= GPIO_MODER_MODER2_0;
	ILI9341_LED_PORT->MODER |= GPIO_MODER_MODER3_0;
